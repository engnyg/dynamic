...
@{Title=$props.Title;Artist=$props.Artist;Album=$props.AlbumTitle;Status=$playback.PlaybackStatus.ToString().ToLower();Source=$session.SourceAppId}|ConvertTo-Json
}else{"null"}
`;
